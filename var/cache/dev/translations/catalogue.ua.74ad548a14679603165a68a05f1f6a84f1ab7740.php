...
$catalogue = new MessageCatalogue('ua', array (
  ...
  array (
    'boolean.yes_or_no' => 'Так або Ні',
    'boolean.yes' => 'Так',
    'boolean.no' => 'Ні',
    'number.equal' => 'Дорівнює',
    'number.greater_than' => 'Більше',
    'number.greater_than_equal' => 'Більше або дорівнює',
    'number.lower_than' => 'Менше',
    'number.lower_than_equal' => 'Менше або дорівнює',
    'text.starts' => 'Починається з',
    'text.ends' => 'Закінчується на',
