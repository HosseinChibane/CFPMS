...
class T_Universite extends \DUDEEGO\PlatformBundle\Entity\T_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'documents', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'formations', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'images', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'adresse', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'nometablissement', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'siteinternet', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'description', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'longetitude', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'latitude', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'telephone', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'classement', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'bourse', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'montantbourse', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'logement', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'partenaire', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'type', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Universite' . "\0" . 'taille'];
        }
