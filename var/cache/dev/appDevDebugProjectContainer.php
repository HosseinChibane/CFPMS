...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'vich_uploader.namer_origname.universites_images' => 'getVichUploader_NamerOrigname_UniversitesImagesService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LexikFormFilterBundle', ($this->targetDirs[3].'\\app/Resources/LexikFormFilterBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LexikFormFilterBundle', ($this->targetDirs[3].'\\vendor\\lexik\\form-filter-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OneupFlysystemBundle', ($this->targetDirs[3].'\\app/Resources/OneupFlysystemBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'OneupFlysystemBundle', ($this->targetDirs[3].'\\vendor\\oneup\\flysystem-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EasyAdminBundle', ($this->targetDirs[3].'\\app/Resources/EasyAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EasyAdminBundle', ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DUDEEGOPlatformBundle', ($this->targetDirs[3].'\\app/Resources/DUDEEGOPlatformBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DUDEEGOPlatformBundle', ($this->targetDirs[3].'\\src\\DUDEEGO\\PlatformBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5eXD21BnaD', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qg9QM6EmuM', 0, 'VtawoH9izyutlRM6uyxGwp', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('universites_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('demandes_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('universites_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('users_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('users_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('universites_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('universites_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('users_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('users_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('users_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('universites_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('universites_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('users_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('users_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('demandes_pdf', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('demandes_pdf', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dudeego', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000001f7007fb000000004b9aebab4e2cd9ee2918cb032d63b80dea84a350(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c1775d1b40af88fb56b86ef01085d844c960c985a6c1cdc2fad8cf2226ac5595');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['fos_user.user_provider.username']) ? $this->services['fos_user.user_provider.username'] : $this->getFosUser_UserProvider_UsernameService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $r, 3 => $u, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $f, $h, $a, $c, true, $i), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '592577b1e3fcb9.33903410', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $p, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $q, 'fos_user_security_login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.fos_userbundle', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig', 2 => 'VichUploaderBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), false, array(), array(0 => 'FOSUserBundle', 1 => 'IvoryCKEditorBundle', 2 => 'StofDoctrineExtensionsBundle', 3 => 'VichUploaderBundle', 4 => 'LiipImagineBundle', 5 => 'LexikFormFilterBundle', 6 => 'AsseticBundle', 7 => 'OneupFlysystemBundle', 8 => 'EasyAdminBundle', 9 => 'FrameworkBundle', 10 => 'SecurityBundle', 11 => 'TwigBundle', 12 => 'MonologBundle', 13 => 'SwiftmailerBundle', 14 => 'DoctrineBundle', 15 => 'SensioFrameworkExtraBundle', 16 => 'DUDEEGOPlatformBundle', 17 => 'DebugBundle', 18 => 'WebProfilerBundle', 19 => 'SensioDistributionBundle', 20 => 'SensioGeneratorBundle', 21 => 'DoctrineFixturesBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension($this->get('var_dumper.cloner'), $e));
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'IvoryCKEditorBundle:Form:ckeditor_widget.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'bootstrap_3_layout.html.twig', 3 => 'VichUploaderBundle:Form:fields.html.twig'), $this->get('twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'vich_uploader.namer_origname.universites_images' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\OrignameNamer A Vich\UploaderBundle\Naming\OrignameNamer instance
     */
    protected function getVichUploader_NamerOrigname_UniversitesImagesService()
    {
        return $this->services['vich_uploader.namer_origname.universites_images'] = new \Vich\UploaderBundle\Naming\OrignameNamer();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('btBjv3MyfZ', 0, 'VtawoH9izyutlRM6uyxGwp', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'vich_uploader.mappings': $value = array(
                ...
                'universites_images' => array(
                    'namer' => array(
                        'service' => 'vich_uploader.namer_origname.universites_images',
                        'options' => array(

                        ),
                    ),
                    'uri_prefix' => '/universites/images',
                    'upload_destination' => ($this->targetDirs[3].'\\app/../web/universites/images'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.bundles' => array(
                0 => 'FOSUserBundle',
                1 => 'IvoryCKEditorBundle',
                2 => 'StofDoctrineExtensionsBundle',
                3 => 'VichUploaderBundle',
                4 => 'LiipImagineBundle',
                5 => 'LexikFormFilterBundle',
                6 => 'AsseticBundle',
                7 => 'OneupFlysystemBundle',
                8 => 'EasyAdminBundle',
                9 => 'FrameworkBundle',
                10 => 'SecurityBundle',
                11 => 'TwigBundle',
                ...
                'design' => array(
                    ...
                    'menu' => array(
                        ...
                        6 => array(
                            ...
                            'children' => array(
                                0 => 'Utilisateur',
                                1 => 'Documents_Utilisateur',
                            ),
                        ),
                        7 => array(
                            'label' => 'Gestion Demandes Inscription',
                            'children' => array(
                                0 => 'Demandes_Inscriptions',
                                1 => 'Documents_Inscriptions',
                            ),
                        ),
                        8 => array(
                            'label' => 'Gestion F.A.Q',
...
class DoctrineORMEntityManager_000000001f7007fb000000004b9aebab4e2cd9ee2918cb032d63b80dea84a350 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder592577b39fd9f021822733 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer592577b39fdb0258695473 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties592577b39fd72509582845 = array(
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getConnection', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getConnection();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getMetadataFactory', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getMetadataFactory();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getExpressionBuilder', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getExpressionBuilder();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'beginTransaction', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->beginTransaction();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getCache', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getCache();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'transactional', array('func' => $func), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->transactional($func);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'commit', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->commit();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'rollback', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->rollback();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getClassMetadata', array('className' => $className), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getClassMetadata($className);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'createQuery', array('dql' => $dql), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->createQuery($dql);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'createNamedQuery', array('name' => $name), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->createNamedQuery($name);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'createQueryBuilder', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->createQueryBuilder();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'flush', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->flush($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'clear', array('entityName' => $entityName), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->clear($entityName);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'close', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->close();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'persist', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->persist($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'remove', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->remove($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'refresh', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->refresh($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'detach', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->detach($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'merge', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->merge($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->copy($entity, $deep);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getRepository', array('entityName' => $entityName), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getRepository($entityName);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'contains', array('entity' => $entity), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->contains($entity);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getEventManager', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getEventManager();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getConfiguration', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getConfiguration();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'isOpen', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->isOpen();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getUnitOfWork', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getUnitOfWork();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getProxyFactory', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getProxyFactory();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'initializeObject', array('obj' => $obj), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->initializeObject($obj);
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'getFilters', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->getFilters();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'isFiltersStateClean', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->isFiltersStateClean();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'hasFilters', array(), $this->initializer592577b39fdb0258695473);

        return $this->valueHolder592577b39fd9f021822733->hasFilters();
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 = $initializer;
    }
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__get', array('name' => $name), $this->initializer592577b39fdb0258695473);

        if (isset(self::$publicProperties592577b39fd72509582845[$name])) {
            return $this->valueHolder592577b39fd9f021822733->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder592577b39fd9f021822733;
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer592577b39fdb0258695473);
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__isset', array('name' => $name), $this->initializer592577b39fdb0258695473);
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__unset', array('name' => $name), $this->initializer592577b39fdb0258695473);
    ...
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__clone', array(), $this->initializer592577b39fdb0258695473);

        $this->valueHolder592577b39fd9f021822733 = clone $this->valueHolder592577b39fd9f021822733;
    }

    public function __sleep()
    {
        $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, '__sleep', array(), $this->initializer592577b39fdb0258695473);

        return array('valueHolder592577b39fd9f021822733');
    }
    ...
    {
        return $this->initializer592577b39fdb0258695473;
    }
    ...
    {
        return $this->initializer592577b39fdb0258695473 && $this->initializer592577b39fdb0258695473->__invoke($this->valueHolder592577b39fd9f021822733, $this, 'initializeProxy', array(), $this->initializer592577b39fdb0258695473);
    }
    ...
    {
        return null !== $this->valueHolder592577b39fd9f021822733;
    }
    ...
    {
        return $this->valueHolder592577b39fd9f021822733;
    }
