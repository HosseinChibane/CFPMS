...
class T_Image_Universite extends \DUDEEGO\PlatformBundle\Entity\T_Image_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Image_Universite' . "\0" . 'universite', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Image_Universite' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Image_Universite' . "\0" . 'libelle', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Image_Universite' . "\0" . 'url', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Image_Universite' . "\0" . 'alt'];
        }
