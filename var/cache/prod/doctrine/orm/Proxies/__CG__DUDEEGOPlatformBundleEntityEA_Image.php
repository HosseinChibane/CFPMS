 ...
 */
class EA_Image extends \DUDEEGO\PlatformBundle\Entity\EA_Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Image' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Image' . "\0" . 'imageName', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Image' . "\0" . 'imageFile', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Image' . "\0" . 'imageSize', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Image' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EA_Image $proxy) {
