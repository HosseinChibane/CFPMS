 ...
 */
class EA_Personne extends \DUDEEGO\PlatformBundle\Entity\EA_Personne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'numero', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'rue', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'codepostal', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'ville', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'pays', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'gsm', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'telephone', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Personne' . "\0" . 'courriel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EA_Personne $proxy) {
    ...
    public function setMorale(\DUDEEGO\PlatformBundle\Entity\EA_Morale $morale = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMorale', [$morale]);

        return parent::setMorale($morale);
    }
    ...
    public function getMorale()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMorale', []);

        return parent::getMorale();
    }
