 ...
 */
class T_Langue_Universite extends \DUDEEGO\PlatformBundle\Entity\T_Langue_Universite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Langue_Universite' . "\0" . 'formation', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Langue_Universite' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\T_Langue_Universite' . "\0" . 'langue'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (T_Langue_Universite $proxy) {
