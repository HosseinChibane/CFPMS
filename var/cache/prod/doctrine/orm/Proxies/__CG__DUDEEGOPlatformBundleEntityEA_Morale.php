 ...
 */
class EA_Morale extends \DUDEEGO\PlatformBundle\Entity\EA_Morale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'personne', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'langues', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'id', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'raisonsocial', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'siret', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'fax', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'naf', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'url', '' . "\0" . 'DUDEEGO\\PlatformBundle\\Entity\\EA_Morale' . "\0" . 'alt'];
        }
